...
type OpenAIWSIngressHooks struct {
	...
	// AfterRequestNormalization observes the final per-turn payload after
	// mapping and normalization for body-log metadata capture.
	AfterRequestNormalization func(turn int, payload []byte, originalModel string)
