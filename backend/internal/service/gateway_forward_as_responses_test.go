...
func TestHandleResponsesBufferedStreamingResponse_RestoresNamespaceTool(t *testing.T) {
	...
	svc := &GatewayService{}
	forwardedBody := []byte(`{"model":"claude-fable-5"}`)
	result, err := svc.handleResponsesBufferedStreamingResponse(resp, c, "claude-fable-5", "claude-fable-5", nil, time.Now(), forwardedBody, namespaceToolMapping())
	require.NoError(t, err)
	require.Equal(t, forwardedBody, result.RequestBody)
...
func TestHandleResponsesStreamingResponse_RestoresNamespaceTool(t *testing.T) {
	...
	svc := &GatewayService{}
	forwardedBody := []byte(`{"model":"claude-fable-5"}`)
	result, err := svc.handleResponsesStreamingResponse(resp, c, "claude-fable-5", "claude-fable-5", nil, time.Now(), forwardedBody, namespaceToolMapping())
	require.NoError(t, err)
	require.Equal(t, forwardedBody, result.RequestBody)
...
func TestHandleResponsesBufferedStreamingResponse_PreservesMessageStartCacheUsage(t *testing.T) {
	...
	svc := &GatewayService{}
	result, err := svc.handleResponsesBufferedStreamingResponse(resp, c, "claude-sonnet-4.5", "claude-sonnet-4.5", nil, time.Now(), []byte(`{"model":"claude-sonnet-4.5"}`), apicompat.ResponsesClientToolMapping{})
	require.NoError(t, err)
...
func TestHandleResponsesStreamingResponse_PreservesMessageStartCacheUsage(t *testing.T) {
	...
	svc := &GatewayService{}
	result, err := svc.handleResponsesStreamingResponse(resp, c, "claude-sonnet-4.5", "claude-sonnet-4.5", nil, time.Now(), []byte(`{"model":"claude-sonnet-4.5"}`), apicompat.ResponsesClientToolMapping{})
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleResponsesBufferedStreamingResponse_CompactSSEFormat(t *testing.T) {
	...
	svc := &GatewayService{}
	result, err := svc.handleResponsesBufferedStreamingResponse(resp, c, "claude-sonnet-4.5", "claude-sonnet-4.5", nil, time.Now(), nil, apicompat.ResponsesClientToolMapping{})
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestHandleResponsesStreamingResponse_CompactSSEFormat(t *testing.T) {
	...
	svc := &GatewayService{}
	result, err := svc.handleResponsesStreamingResponse(resp, c, "claude-sonnet-4.5", "claude-sonnet-4.5", nil, time.Now(), nil, apicompat.ResponsesClientToolMapping{})
	require.NoError(t, err)
	require.NotNil(t, result)
