...
func (h *OpenAIGatewayHandler) ResponsesWebSocket(c *gin.Context) {
	...
	for {
		...
		hooks := &service.OpenAIWSIngressHooks{
			...
			AfterRequestNormalization: func(turn int, payload []byte, _ string) {
			...
			AfterTurn: func(turn int, result *service.OpenAIForwardResult, turnErr error) {
				...
				h.recordCyberPolicyIfMarked(c, apiKey, account, subscription, reqModel, turnErr != nil, cyberBlockKey, clientRequestedUsageFields(c, channelMappingWS, reqModel, ""), turnRequestSnapshot.hash)
				if service.GetOpsCyberPolicy(c) != nil {
