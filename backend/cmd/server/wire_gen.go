...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	gatewayBodyLogRepository := repository.NewGatewayBodyLogRepository(client, db)
	gatewayBodyLogService := service.NewGatewayBodyLogService(gatewayBodyLogRepository, settingService)
	gatewayService := service.ProvideGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, serviceUserPlatformQuotaRepository, gatewayBodyLogService)
	...
	adminUsageHandler := handler.ProvideAdminUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, gatewayBodyLogService)
