    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiAllowClaudeCodeCodexPluginDesc:
          'Legacy compatibility option. New versions migrate this allowlist into the Codex client restriction policy.',
        bodyLogTitle: 'Body Logging',
        bodyLogDescription: 'Persist truncated request and response bodies for gateway-forwarded traffic to help diagnose upstream compatibility issues and payload differences.',
        bodyLogEnabled: 'Enable body logging',
        bodyLogEnabledHint: 'When disabled, request and response bodies are not stored; only the usual usage and error logs remain.',
        bodyLogMaxBytes: 'Max bytes per side',
        bodyLogMaxBytesHint: 'Each request body and response body is truncated independently to this limit before being stored. Valid range: 1 to 1048576 bytes; the backend normalizes out-of-range values.',
        bodyLogCaptureRequest: 'Capture request body',
        bodyLogCaptureRequestHint: 'Store a snapshot of the request body before it is forwarded upstream.',
        bodyLogCaptureResponse: 'Capture response body',
        bodyLogCaptureResponseHint: 'Store a snapshot of the response body returned by the upstream.',
